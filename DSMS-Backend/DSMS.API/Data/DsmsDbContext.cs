...
public partial class DsmsDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TrainingSession>(entity =>
        {
            ...
            entity.Property(e => e.VehicleClass).HasMaxLength(20);
            entity.Property(e => e.Status).HasMaxLength(20);
            entity.Property(e => e.DurationHours).HasColumnType("decimal(4, 1)");
            entity.Property(e => e.HoursLogged).HasColumnType("decimal(4, 1)");
            entity.Property(e => e.SessionNotes).HasMaxLength(1000);
            ...
            entity.HasOne(d => d.Student).WithMany()
                .HasForeignKey(d => d.StudentId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_TS_Student");

            entity.HasOne(d => d.Instructor).WithMany()
                .HasForeignKey(d => d.InstructorId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_TS_Instructor");

            entity.HasOne(d => d.Branch).WithMany()
                .HasForeignKey(d => d.BranchId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_TS_Branch");
        });
