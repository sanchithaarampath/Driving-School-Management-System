namespace DSMS.API.DTOs
{
    ...
    public class CoursePackageDto
    {
        ...
        public int TrainingDays { get; set; } = 15;
    ...
    {
        public string? IssuedLicenseNo   { get; set; }
    ...
    public class TrainingSessionCreateDto
    {
        public int StudentId { get; set; }
        public int InstructorId { get; set; }
        public string ScheduledDate { get; set; } = "";   // "2026-05-10"
    ...
    public class TrainingSessionCancelDto
    {
        public string Status { get; set; } = "Cancelled";  // Cancelled | NoShow
