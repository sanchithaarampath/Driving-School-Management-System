  ...
  template: `
    <div class="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <ng-container *ngIf="!isInstructor">
          <a class="nav-item" routerLink="/training-schedule" routerLinkActive="active">
            <i class="bi bi-calendar3"></i><span>Training Scheduler</span>
          </a>
        </ng-container>
        <ng-container *ngIf="isBranchAdmin || isCompanyAdmin">
          <a class="nav-item" routerLink="/exam" routerLinkActive="active" [routerLinkActiveOptions]="{exact:true}">
            <i class="bi bi-clipboard-check"></i><span>Exam Results</span>
          </a>
          <a class="nav-item nav-sub" routerLink="/exam/practical-tests" routerLinkActive="active">
            <i class="bi bi-clipboard2-pulse"></i><span>Practical Tests</span>
          </a>
          <a class="nav-item" routerLink="/instructors" routerLinkActive="active">
