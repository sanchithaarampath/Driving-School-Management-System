...
export class CoursePackagesPage implements OnInit {
  ...
  get canManage() { return this.auth.isCompanyAdmin(); }
  ...
  openCreate() {
    ...
    this.form = { id: 0, packageName: '', courseType: 'Full Course', selectedCodes: [], price: 0, maxDiscount: 0, trainingDays: 15, description: '' };
    this.saveSuccess = '';
    this.saveError   = '';
    this.showModal   = true;
  }
  ...
  openEdit(pkg: any) {
    ...
    this.form = {
      ...
      trainingDays:  pkg.trainingDays ?? 15,
  ...
  save() {
    ...
    const payload = {
      ...
      trainingDays:      this.form.trainingDays || 15,
